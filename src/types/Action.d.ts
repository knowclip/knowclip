...
declare type SetMediaFolderLocation =
  import('../actions').ActionOf<'setMediaFolderLocation'>
declare type AddAssetsDirectories =
  import('../actions').ActionOf<'addAssetsDirectories'>
declare type RemoveAssetsDirectories =
  import('../actions').ActionOf<'removeAssetsDirectories'>
declare type SetCheckForUpdatesAutomatically =
  import('../actions').ActionOf<'setCheckForUpdatesAutomatically'>
declare type OverrideSettings =
  import('../actions').ActionOf<'overrideSettings'>
declare type AddActiveDictionary =
  import('../actions').ActionOf<'addActiveDictionary'>
declare type RemoveActiveDictionary =
  import('../actions').ActionOf<'removeActiveDictionary'>
declare type DetectSilence = import('../actions').ActionOf<'detectSilence'>
declare type DetectSilenceRequest =
  import('../actions').ActionOf<'detectSilenceRequest'>
declare type DeleteAllCurrentFileClipsRequest =
  import('../actions').ActionOf<'deleteAllCurrentFileClipsRequest'>
declare type SetAllTags = import('../actions').ActionOf<'setAllTags'>
declare type SetFlashcardField =
  import('../actions').ActionOf<'setFlashcardField'>
declare type AddFlashcardTag = import('../actions').ActionOf<'addFlashcardTag'>
declare type DeleteFlashcardTag =
  import('../actions').ActionOf<'deleteFlashcardTag'>
declare type SetDefaultClipSpecs =
  import('../actions').ActionOf<'setDefaultClipSpecs'>
...
declare type StartEditingCards =
  import('../actions').ActionOf<'startEditingCards'>
declare type StopEditingCards =
  import('../actions').ActionOf<'stopEditingCards'>
declare type OpenDictionaryPopover =
  import('../actions').ActionOf<'openDictionaryPopover'>
declare type CloseDictionaryPopover =
  import('../actions').ActionOf<'closeDictionaryPopover'>
declare type NewCardFromSubtitlesRequest =
  import('../actions').ActionOf<'newCardFromSubtitlesRequest'>
declare type SelectWaveformItem =
  import('../actions').ActionOf<'selectWaveformItem'>
declare type SetCursorPosition =
  import('../actions').ActionOf<'setCursorPosition'>
declare type GenerateWaveformImages =
  import('../actions').ActionOf<'generateWaveformImages'>
...
declare type OpenProjectRequestById =
  import('../actions').ActionOf<'openProjectRequestById'>
declare type OpenProjectRequestByFilePath =
  import('../actions').ActionOf<'openProjectRequestByFilePath'>
...
declare type CloseProjectRequest =
  import('../actions').ActionOf<'closeProjectRequest'>
declare type SaveProjectRequest =
  import('../actions').ActionOf<'saveProjectRequest'>
declare type SaveProjectAsRequest =
  import('../actions').ActionOf<'saveProjectAsRequest'>
declare type ExportApkgRequest =
  import('../actions').ActionOf<'exportApkgRequest'>
declare type ExportApkgFailure =
  import('../actions').ActionOf<'exportApkgFailure'>
declare type ExportApkgSuccess =
  import('../actions').ActionOf<'exportApkgSuccess'>
...
declare type AddMediaToProjectRequest =
  import('../actions').ActionOf<'addMediaToProjectRequest'>
declare type SetWorkIsUnsaved =
  import('../actions').ActionOf<'setWorkIsUnsaved'>
declare type MountSubtitlesTrack =
  import('../actions').ActionOf<'mountSubtitlesTrack'>
...
declare type MakeClipsFromSubtitles =
  import('../actions').ActionOf<'makeClipsFromSubtitles'>
declare type ShowSubtitlesClipsDialogRequest =
  import('../actions').ActionOf<'showSubtitlesClipsDialogRequest'>
declare type LinkFlashcardFieldToSubtitlesTrackRequest =
  import('../actions').ActionOf<'linkFlashcardFieldToSubtitlesTrackRequest'>
declare type AddFile = import('../actions').ActionOf<'addFile'>
declare type GoToSubtitlesChunk =
  import('../actions').ActionOf<'goToSubtitlesChunk'>
declare type DeleteFileRequest =
  import('../actions').ActionOf<'deleteFileRequest'>
declare type DeleteFileSuccess =
  import('../actions').ActionOf<'deleteFileSuccess'>
...
declare type LocateFileRequest =
  import('../actions').ActionOf<'locateFileRequest'>
declare type LocateFileSuccess =
  import('../actions').ActionOf<'locateFileSuccess'>
declare type UpdateFile = import('../actions').ActionOf<'updateFile'>
declare type CommitFileDeletions =
  import('../actions').ActionOf<'commitFileDeletions'>
declare type AbortFileDeletions =
  import('../actions').ActionOf<'abortFileDeletions'>
declare type SetProgress = import('../actions').ActionOf<'setProgress'>
declare type PreloadVideoStills =
  import('../actions').ActionOf<'preloadVideoStills'>
declare type DeleteImportedDictionary =
  import('../actions').ActionOf<'deleteImportedDictionary'>
declare type ResetDictionariesDatabase =
  import('../actions').ActionOf<'resetDictionariesDatabase'>
declare type ImportDictionaryRequest =
  import('../actions').ActionOf<'importDictionaryRequest'>
declare type StartDictionaryImport =
  import('../actions').ActionOf<'startDictionaryImport'>
