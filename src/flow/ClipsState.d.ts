...
declare type FlashcardFieldName = TransliterationFlashcardFieldName | SimpleFlashcardFieldName


declare type TransliterationFlashcardFieldName = "transcription" | "pronunciation" | "meaning" | "notes";
...
declare type FlashcardFields = SimpleFlashcardFields | TransliterationFlashcardFields

declare type SimpleFlashcardFields = { [K in SimpleFlashcardFieldName]: string }
declare type TransliterationFlashcardFields = { [K in TransliterationFlashcardFieldName]: string }
