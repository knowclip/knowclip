...
export const setFlashcardField = (id: ClipId, key: string, value: string): Action => ({
...
export const deleteFlashcardTag = (id: ClipId, index: number, tag: string): Action => ({
...
export const exportCsv = (clipIds: Array<ClipId>, csvFilePath: string, mediaFolderLocation: string): Action => ({
  type: 'EXPORT_CSV',
  clipIds,
  csvFilePath,
  mediaFolderLocation
