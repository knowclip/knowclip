...
const initialStateMinusMeta: Omit<
  SessionState,
...
export default function getSessionReducer(meta: MinimalInitialSessionState) {
  const initialState: SessionState = {
    ...initialStateMinusMeta,
    ...meta,
  }
  const session: Reducer<SessionState, Action> = (
    ...
    switch (action.type) {
      ...
      case A.setMediaMetadata:
        return {
          ...state,
          currentMediaFileMetadata: action.metadata,
        }
