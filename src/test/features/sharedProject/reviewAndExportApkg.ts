...
import { testLabels as dialogTableRow } from '../../../components/ReviewAndExportMediaTableRow'
...
export default async function reviewAndExportApkg({ client, app }: TestSetup) {
  ...
  const [first, , third] = await client.elements_(dialogTableRow.clipCheckboxes)
